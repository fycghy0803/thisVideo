 ...
 */
package com.lxht.emos.data.cache.intf;
...
//import com.lxht.emos.data.publiccommon.service.CommonDbService;
...
public class HessianUtil {
     ...
     * @throws IOException
     */
    public static <T extends Object> List<T> deserializeCollection(Collection<byte[]> rSet) throws IOException {
        if (rSet == null) {
            throw new NullPointerException();
        }
