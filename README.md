...
<p>Run and build this source before need add a system envirment parameter which names EMOS_SOURCE_ENV,its values can be DEV,UNITTEST,PROD,it mean which jdbc.properties will be used</p>
